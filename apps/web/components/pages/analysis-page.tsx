...
// ─── Clean Initial Analytics State ─────────────────────────────────────────────
const EMPTY_ANALYTICS_DATA: AnalyticsData = {
  buyer: {
    overview: {
      totalCcSpent: '0 CC',
      activeSubscriptions: '0',
      contentRead: '0 articles',
      jobsPosted: '0 posts',
    },
    reader: {
      readThisMonth: 0,
  ...
  seller: {
    overview: {
      totalCcEarned: '0 CC',
      activeJobs: '0 active',
      jobsCompleted: '0 done',
      avgRating: '0.0 stars',
    },
    earnings: {
      earnedThisMonth: '0 CC',
      earnedLastMonth: '0 CC',
      earnedAllTime: '0 CC',
      pendingEarnings: '0 CC',
      feesPaid: '0 CC',
      largestJob: '0 CC',
      avgEarnedPerJob: '0 CC',
      chartData: [],
    },
    jobPerformance: {
      applicationsSent: 0,
    ...
    deposits: {
      totalDepositsPaid: '0 CC',
      totalDepositsRefunded: '0 CC',
      depositsPendingRefund: '0 CC',
      netDepositCost: '0 CC',
    },
  },
};
